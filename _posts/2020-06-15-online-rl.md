...
![MARL]({{ site.baseurl }}/images/posts_images/ddpg_post/marl1.png " source: https://arxiv.org/pdf/1706.05296.pdf ")
...
![VDN]({{ site.baseurl }}/images/posts_images/ddpg_post/vdn1.png " source: https://arxiv.org/pdf/1706.05296.pdf ")

Consider a case with 2 agents, the reward would be:

![VDN]({{ site.baseurl }}/images/posts_images/ddpg_post/vdn2.png)

Then the total Q function is:

![VDN]({{ site.baseurl }}/images/posts_images/ddpg_post/vdn3.png)
...
![QMIX]({{ site.baseurl }}/images/posts_images/ddpg_post/qmix1.png " source: https://arxiv.org/pdf/1803.11485.pdf")
...
![MADDPG]({{ site.baseurl }}/images/posts_images/ddpg_post/maddpg.png " source: https://arxiv.org/pdf/1706.02275.pdf ")

The centralised action-value function for each agent can be written as:

![MADDPG]({{ site.baseurl }}/images/posts_images/ddpg_post/maddpg2.png)

And the gradient can be written as follows:

![MADDPG]({{ site.baseurl }}/images/posts_images/ddpg_post/maddpg3.png)
...
The talk can be found \href{https://www.youtube.com/watch?v=3OVvjE5B9LU}{here}.
...
![COMA]({{ site.baseurl }}/images/posts_images/ddpg_post/coma.png " source: https://www.aaai.org/ocs/index.php/AAAI/AAAI18/paper/viewPaper/17193 ")
...
![COMA]({{ site.baseurl }}/images/posts_images/ddpg_post/coma2.png)
